...
export default {
  ...
  methods: {
    search: function() {
      axios.get("getCrowdFundContract", {
        ...
        {
          this.$notify.success({
            title: 'getCrowdFundContract',
            message: `getCrowdFundContract success`
          });
        ...
        else
        {
          this.$notify.error({
            title: 'getCrowdFundContract',
            message: `getCrowdFundContract failed, ${msg}`
          });
        }
      }).finally(() => {
    ...
    create: function() {
      axios.get("createCrowdFundContract", Object.assign({
        url: this.currentNode.url,
        ...
        {
          this.$notify.success({
            title: 'createCrowdFundContract',
            message: `createCrowdFundContract success`
          });
        ...
        else
        {
          this.$notify.error({
            title: 'createCrowdFundContract',
            message: `createCrowdFundContract failed, ${msg}`
          });
        }
      }).finally(() => {
    ...
    fund: function() {
      ...
      if(now > this.searchConstractDetail.endTime || now < this.searchConstractDetail.beginTime)
      {
        return this.$notify.error({
          title: 'fundCrowdFundContract',
          message: `fundCrowdFundContract contract has expired`
        });
      }

      axios.get("fundCrowdFundContract", {
        url: this.currentNode.url,
        ...
        if(code === 0)
        {
          this.$notify.success({
            title: 'fundCrowdFundContract',
            message: `fundCrowdFundContract success`
          });
        ...
        else
        {
          this.$notify.error({
            title: 'fundCrowdFundContract',
            message: `fundCrowdFundContract failed, ${msg}`
          });
        }
      }).finally(() => {
    ...
    refund: function() {
      ...
      {
        return this.$notify.error({
          title: 'reFundCrowdFundContract',
          message: `reFundCrowdFundContract contract has not ended`
        });
      }
      
      axios.get("reFundCrowdFundContract", {
        url: this.currentNode.url,
        to: this.constractAddress,
        privateKey: this.privateKey,
        value: 10
        ...
        if(code === 0)
        {
          this.$notify.success({
            title: 'reFundCrowdFundContract',
            message: `reFundCrowdFundContract success`
          });
        ...
        else
        {
          this.$notify.error({
            title: 'reFundCrowdFundContract',
            message: `reFundCrowdFundContract failed, ${msg}`
          });
        }
      }).finally(() => {
    ...
    receive: function() {
      ...
      {
        return this.$notify.error({
          title: 'receiveCrowdFundContract',
          message: `receiveCrowdFundContract contract has not ended`
        });
      }

      axios.get("receiveCrowdFundContract", {
        url: this.currentNode.url,
        to: this.constractAddress,
        privateKey: this.privateKey,
        value: 10
        ...
        if(code === 0)
        {
          this.$notify.success({
            title: 'receiveCrowdFundContract',
            message: `receiveCrowdFundContract success`
          });
        ...
        else
        {
          this.$notify.error({
            title: 'receiveCrowdFundContract',
            message: `receiveCrowdFundContract failed, ${msg}`
          });
        }
      }).finally(() => {
        this.receive = false;
